...
export class AuthAnalyzerPanel {
    ...
    render() {
        ...
        sortedResults.forEach((result, sortIdx) => {
            // ORIGINAL INDEX needed for data-idx to match this.results (if used for deletion/updates)
            // But we are rendering a view. Let's find the original index in this.results.
